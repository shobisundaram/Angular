...
@Component({
  selector: "ngx-solar-chart-rider",
  templateUrl: "./solar-chart-rider.component.html",
  styleUrls: ["./solar-chart-rider.component.scss"],
})
export class SolarChartRiderComponent
