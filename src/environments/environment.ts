...
export class AppSettings {
  ...
  public static googleAutocomplete = false; // if it is true fetch location via google map. else fetch our database.
}
...
export const environment = {
  ...
  // driver_App_link: 'https://play.google.com/store/apps/details?id=com.rebustar.driver',
  // rider_App_link: 'https://play.google.com/store/apps/details?id=com.rebustar.rider',
  // driver_Android_link: 'https://play.google.com/store/apps/details?id=com.rebustar.driver',
  // rider_Android_link: 'https://play.google.com/store/apps/details?id=com.rebustar.rider',
};

export class featuresSettings {
  public static isdownload = true;
...
export class CommonData {
  ...
  public static defaultLanguage = [
    { indexName: "en", name: "English" },
    // { indexName: "es", name: "Spanish" },
    // { indexName: "ta", name: "Tamil" },
  ];
  ...
  public static LowerServiceTypes = [{ value: 0, label: "Mini" }];
  ...
  public static outstationTripType = [
    { value: "round", title: "Round Trip" },
    { value: "oneway", title: "Oneway Trip" },
  ];
  public static outstationTripTypeTable = [
    { value: "", title: "All" },
    { value: "round", title: "Round Trip" },
    { value: "oneway", title: "Oneway Trip" },
  ];
